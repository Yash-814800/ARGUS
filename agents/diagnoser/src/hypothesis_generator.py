...
class HypothesisGenerator:
    ...
    async def _gemini_generate(
        ...
        try:
            ...
            logger.exception("Gemini generation failed for incident %s: %s. Falling back to heuristic.", incident_id, e)
            return self._generate_dummy_hypothesis(context)
    ...
    async def _openai_generate(
        ...
        try:
            ...
            logger.exception("OpenAI generation failed for incident %s. Falling back to heuristic.", incident_id)
            return self._generate_dummy_hypothesis(context)
